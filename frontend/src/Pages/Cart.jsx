...
import {
  ShoppingBasket, ShoppingCart, Trash2, X, AlertTriangle,
  ShieldCheck, Zap, MapPin, ArrowLeft, RefreshCw,
} from 'lucide-react';
import './Cart.css';
      ...
      <div className="um-cart-page">
        <div className="container">
          <div className="um-empty-cart card">
            <div className="um-empty-cart-icon">
              <ShoppingBasket size={48} strokeWidth={1.25} />
            </div>
            <h2>{t('emptyCart')}</h2>
            <p>{t('emptyCartDesc')}</p>
      ...
      <div className="container">
        <div className="um-cart-header">
          ...
          <button
            ...
            disabled={loading}
          >
            <Trash2 size={14} strokeWidth={1.75} /> Clear Cart
          </button>
        </div>
        ...
        <div className="um-cart-layout">
          ...
          <div className="um-cart-summary card">
            ...
            >
              {isAuthenticated ? t('checkout') : 'Login & Checkout'} &rarr;
            </button>

            <div className="um-summary-guarantees">
              <div><ShieldCheck size={14} strokeWidth={1.75} /> Quality guarantee on delivery</div>
              <div><Zap size={14} strokeWidth={1.75} /> Mobile Money payments (MTN / Airtel)</div>
              <div><MapPin size={14} strokeWidth={1.75} /> Home delivery or station pickup</div>
            </div>
          </div>
        </div>
      </div>
